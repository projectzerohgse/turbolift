class SurveyController < ApplicationController
  ...
  def launch
    ...
    if(response['grade'] != 'complete')
       redirect_to generate_url("https://harvard.az1.qualtrics.com/jfe/form/SV_6zDfO7bciNKCi2h", :canvas_user_id => "#{session[:user_id]}", :canvas_course_id => "#{session[:course_id]}")
    end
